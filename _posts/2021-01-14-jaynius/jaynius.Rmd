...
jayz.albums.filled$album <- if_else(jayz.albums.filled$album == "The-blueprint-2-the-gift-the-curse", "The Blueprint 2 The Gift The Curse",jayz.albums.filled$album)
jayz.albums.filled$album <- if_else(jayz.albums.filled$album == "Reasonable-Doubt", "Reasonable Doubt",jayz.albums.filled$album)
